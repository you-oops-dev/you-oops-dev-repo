...
#Mirror's
#Server = https://github.limoruirui.com/https://github.com/you-oops-dev/you-oops-dev-repo/releases/latest/download
#Server = https://hub.gitmirror.com/https://github.com/you-oops-dev/you-oops-dev-repo/releases/latest/download
```

OR in one command in terminal:
```
echo -e "\n[you-oops-dev-repo]\nSigLevel = Optional\nServer = https://github.com/you-oops-dev/you-oops-dev-repo/releases/latest/download\n##Mirror's\n#Server = https://github.limoruirui.com/https://github.com/you-oops-dev/you-oops-dev-repo/releases/latest/download\n#Server = https://hub.gitmirror.com/https://github.com/you-oops-dev/you-oops-dev-repo/releases/latest/download" | sudo tee -ia /etc/pacman.conf
```
